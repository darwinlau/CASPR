...
QuadSurf.implicit_equation = @(x,y,z) (x - 0.5)^2 + (y - 0.5)^2 + (z - 0.5)^2 - 0.05
QuadSurf.boundary = [0.25 0.75 0.25 0.75 0.25 0.75];

QuadSurf.implicit_equation = @(x,y,z) (x - 0.5)^2 + (y - 0.5)^2 + (z - 0.5)^2 - 0.03
QuadSurf.boundary = [0.25 0.75 0.25 0.75 0.25 0.75];
...
%%
clf
ob1 = fimplicit3(QuadSurf.implicit_equation,'FaceColor',[0.5 0.5 0.5],'EdgeColor','none','FaceAlpha',0.4);
