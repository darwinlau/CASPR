        ...
        function [cable_forces,Q_opt, id_exit_type] = resolveFunction(obj, dynamics)            
            ...
            switch (obj.lp_solver_type)
                case ID_LP_SolverType.MATLAB
                    ...
                    [cable_forces, id_exit_type] = id_lp_matlab(obj.objective.b, A_ineq, A_ineq, A_eq, b_eq, fmin, fmax, obj.f_previous,obj.options);
                case ID_LP_SolverType.OPTITOOLBOX_CLP
                    [cable_forces, id_exit_type] = id_lp_optitoolbox_clp(obj.objective.b, A_ineq, A_ineq, A_eq, b_eq, fmin, fmax, obj.f_previous);
                otherwise
