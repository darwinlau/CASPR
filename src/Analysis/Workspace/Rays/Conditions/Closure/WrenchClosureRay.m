...
%             end
            ...
            null_matrix = zeros(maximum_degree+1,number_combinations,number_secondary_combinations,number_dofs+1);
            ...
            polynomial_coefficients_null = zeros(number_dofs+1,maximum_degree+1); % Initialised once it is always completely updated
            for combination_index = 1:number_combinations
                if(leading_zero_number(combination_index) ~= -1)
