...
%                     tic
                    %                     [q_intersected,intersected_pts] = CurveSurfaceIntersection(obj,Segment,parametric_cable_surf_uv,Att_pts{1}(i,:)',q_begin,q_end);
                    [q_intersected,intersected_pts] = CurveSurfaceIntersection(obj,Segment,parametric_cable_surf_uv,Att_pts{1}(i,:)',q_begin,q_end,R_coeff,T_coeff,rGAi,rOAi,QuadSurfCoeff);
...
%                     toc
    ...
    methods (Access = private)
        ...
        function [q_intersected,intersected_pts] = CurveSurfaceIntersection(obj,t_equ,uv_equ,base_att,q_begin,q_end,R_coeff,T_coeff,rGAi,rOAi,QuadSurfCoeff)
            syms t u;
            s1 = QuadSurfCoeff(1);
            s2 = QuadSurfCoeff(2);
            s3 = QuadSurfCoeff(3);
