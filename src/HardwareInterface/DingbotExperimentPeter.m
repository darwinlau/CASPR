...
classdef DingbotExperimentPeter < ExperimentBase
...
%             q_d_prev = trajectory.q_dot{1};
       ...
       t= 1;
           while t < length(trajectory.timeVector)
              obj.hardwareInterface.handGripfeedback();    %get hand grip feedback
              if (handsoff ==true)
                  fprintf(obj.serial_port, [obj.hardwareInterface.RECEIVE_HAND_GRIP '\n']);
              else
