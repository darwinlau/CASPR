...
% cable_set_id = 'dualcables_4by4by4_demo';
% trajectory_id = 'workspace_test';
...
% end
% duration = toc;
% fprintf('The avarage time for each update is %0.3fs.',duration/length(trajectory.timeVector));
