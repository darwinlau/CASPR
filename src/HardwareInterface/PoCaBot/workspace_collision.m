...
width_pickup_place = 0.4;
height_pickup_place = 0.5;

% The central coordinate of the pickup area
pickup_place_co = [length_frame/4,0,0];
...
%% For premise 1
pick_up_point_8_co = [pickup_place_co(1)-length_end/2; -width_pickup_place/2+width_end/2;(height_pickup_place - height_frame/2 +length_hand)];
