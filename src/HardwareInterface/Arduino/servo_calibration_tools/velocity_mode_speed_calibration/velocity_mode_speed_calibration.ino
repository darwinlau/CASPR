...
void loop() {
  if (Serial.available() > 0) {
    ...
    double pwmChangeOverTime = (double)pwmChange / (timeNow - LastTime) * 50;  //microsecond / 50ms   
...
//    Serial.print("\t");
//    Serial.print(pwmChangeOverTime);
    Serial.print("\t");
...
//    Serial.print("\t");
//    Serial.print((timeNow - LastTime));
//    Serial.print("\t");
//    Serial.println(pwmChangeOverTime);
    Serial.flush();
